...
export default function RedeemCardsPage() {
  ...
  const fetchCards = async () => {
    try {
      ...
      toast({
        title: 'Error',
        description: 'Failed to load redeem cards',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold">Redeem Cards</h1>
        <p className="text-muted-foreground mt-2">
          Purchase redeem cards to top up your wallet
        </p>
      </div>
